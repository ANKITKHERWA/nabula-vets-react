            ...
            <div className="max-w-[1364px] px-8 max-sm:pb-[111px] py-[60px] mx-auto">
                <div className="flex justify-between gap-10 max-[950px]:flex-wrap">
                    <div className="max-w-[309px]">
                        <label className="text-[#D7D9DD] text-base sm:text-lg md:text-xl lg:text-2xl mb-6 Roboto-font"
                            htmlFor="email">Stay in touch:</label>
                        <input
                        ...
                        <div className="flex gap-5 mt-[15px] md:mt-[22px]">
                            <Link className="hover:scale-[1.05] duration-200 " href="https://www.facebook.com/login.php/"
                                target="_blank"><svg className="max-[400px]:max-w-[39px]" xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    <path
                                        ...
                                        fill="url(#paint0_linear_1720_1398)"></path>
                                    <defs>
                                        <linearGradient id="paint0_linear_1720_1398" x1="0" y1="0.622559" x2="49.2955"
                                            y2="0.622558" gradientUnits="userSpaceOnUse">
                                            <stop stopColor="#FFA280"></stop>
                                            <stop offset="1" stopColor="#8FD9D9"></stop>
                                        </linearGradient>
                                    </defs>
                                </svg>
                            </Link>
                            <Link className="hover:scale-[1.05] duration-200" href="https://in.linkedin.com/"
                                target="_blank"><svg className="max-[400px]:max-w-[39px]" xmlns="http://www.w3.org/2000/svg"
                                    width="50" height="51" viewBox="0 0 50 51" fill="none">
                                    <path
                                        ...
                                        fill="url(#paint0_linear_1720_1397)"></path>
                                    <defs>
                                        <linearGradient id="paint0_linear_1720_1397" x1="0.656616" y1="0.622559"
                                            x2="49.9521" y2="0.622558" gradientUnits="userSpaceOnUse">
                                            <stop stopColor="#FFA280"></stop>
                                            <stop offset="1" stopColor="#8FD9D9"></stop>
                                        </linearGradient>
                                    </defs>
                            ...
                            <Link className="hover:scale-[1.05] duration-200"
                                href="https://www.instagram.com/accounts/login/?hl=en" target="_blank"><svg
                                    className="max-[400px]:max-w-[39px]" xmlns="http://www.w3.org/2000/svg" width="50"
                                    height="51" viewBox="0 0 50 51" fill="none">
                                    <path
                                        ...
                                        fill="url(#paint0_linear_1720_1396)"></path>
                                    <defs>
                                        <linearGradient id="paint0_linear_1720_1396" x1="0.313354" y1="0.698242"
                                            x2="49.6089" y2="0.698242" gradientUnits="userSpaceOnUse">
                                            <stop stopColor="#FFA280"></stop>
                                            <stop offset="1" stopColor="#8FD9D9"></stop>
                                        </linearGradient>
                                    </defs>
                    ...
                    <div
                        className="flex max-sm:flex-wrap gap-y-[30px] max-sm:gap-x-[150px] max-md:gap-x-[100px] gap-x-[55px]">
                        <div className="flex flex-col gap-[10px] md:gap-[30px]">
                            <h4 className="Roboto-font text-[#D7D9DD] text-base sm:text-lg md:text-xl lg:text-2xl">
                                Services
                            </h4>
                            <div className="flex flex-col gap-[7px]">
                                <Link className="text-[#D7D9DD] text-sm sm:text-base underline hover:text-transparent bg-clip-text bg-gradient-to-r from-[#FFA280] to-[#8FD9CB] duration-300"
                                    href="./veterinary-services.html#pre-care">Preventive Care</Link>
                                <Link className="text-[#D7D9DD] text-sm sm:text-base underline hover:text-transparent bg-clip-text bg-gradient-to-r from-[#FFA280] to-[#8FD9CB] duration-300"
                                    href="./veterinary-services.html#sik">Sick Patient Care</Link>
                                <Link className="text-[#D7D9DD] text-sm sm:text-base underline hover:text-transparent bg-clip-text bg-gradient-to-r from-[#FFA280] to-[#8FD9CB] duration-300"
                                    href="./veterinary-services.html#surgery">Surgery</Link>
                                <Link className="text-[#D7D9DD] text-sm sm:text-base underline hover:text-transparent bg-clip-text bg-gradient-to-r from-[#FFA280] to-[#8FD9CB] duration-300"
                                    href="./veterinary-services.html#add-service">Additional Services</Link>
                            </div>
                        </div>
                        <div className="flex flex-col gap-[10px] md:gap-[30px]">
                            <h4 className="Roboto-font text-[#D7D9DD] text-base sm:text-lg md:text-xl lg:text-2xl">
                            ...
                            <div className="flex flex-col gap-[7px]">
                                <Link className="text-[#D7D9DD] text-sm sm:text-base underline hover:text-transparent bg-clip-text bg-gradient-to-r from-[#FFA280] to-[#8FD9CB] duration-300"
                                    href="./about-us.html">About us</Link>
                                <Link className="text-[#D7D9DD] text-sm sm:text-base underline hover:text-transparent bg-clip-text bg-gradient-to-r from-[#FFA280] to-[#8FD9CB] duration-300"
                                    href="./join-our-nebula-vets-team.html">Carreers</Link>
                            </div>
                        </div>
                        <div className="flex flex-col gap-[10px] md:gap-[30px] xl:ml-[57px] xl:mr-[145px]">
                            ...
                            <div className="flex flex-col gap-[7px]">
                                <Link className="text-[#D7D9DD] text-sm sm:text-base underline hover:text-transparent bg-clip-text bg-gradient-to-r from-[#FFA280] to-[#8FD9CB] duration-300"
                                    href="tel:+91 2121234567">Phone: (212) 123-4567</Link>
                                <Link className="text-[#D7D9DD] text-sm sm:text-base underline hover:text-transparent bg-clip-text bg-gradient-to-r from-[#FFA280] to-[#8FD9CB] duration-300"
                                    href="mailto:hello@gmail.com">hello@nebulavets.com</Link>
                            </div>
                        </div>
                    </div>
                </div>
